    ...
    <>
      <style>{String.raw`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .login-btn{transition:all .3s ease}
        .login-btn:hover:not(:disabled){box-shadow:0 0 24px rgba(0,85,255,0.5),0 4px 14px rgba(0,0,0,.2)!important;transform:translateY(-2px)}
